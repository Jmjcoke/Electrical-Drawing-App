...
exports.defaultFollowUpConfig = exports.FollowUpDetectorService = void 0;
class FollowUpDetectorService {
     ...
     */
    async detectFollowUp(currentQuery, conversationHistory) {
        ...
        const contextualEnrichment = await this.enrichQueryWithContext(currentQuery, detectedReferences, recentTurns);
        return {
            originalQuery: currentQuery.originalText,
            detectedReferences,
     ...
     */
    shouldApplyFallback(followUpResult) {
     ...
     */
    async applyFallbackHandling(followUpResult) {
        return {
            ...followUpResult,
    ...
    detectPronounReferences(query, recentTurns) {
        const references = [];
    ...
    detectTemporalReferences(query, _recentTurns) {
        const references = [];
        const queryWords = query.cleanedText.toLowerCase().split(/\s+/);
    ...
    detectImplicitReferences(query, _recentTurns) {
        const references = [];
        const queryWords = query.cleanedText.toLowerCase().split(/\s+/);
    ...
    detectSpatialReferences(query, _recentTurns) {
        const references = [];
    ...
    findPronounReferent(_pronoun, recentTurns) {
    ...
    async enrichQueryWithContext(query, references, recentTurns) {
    ...
    extractRecentContext(recentTurns) {
...
exports.FollowUpDetectorService = FollowUpDetectorService;
// Default configuration
exports.defaultFollowUpConfig = {
