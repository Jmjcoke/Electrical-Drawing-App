...
exports.ContextMonitorService = void 0;
...
class ContextMonitorService {
     ...
     */
    monitorOperation(operation, executionTimeMs, contextId, sessionId, success = true, _errorMessage) {
     ...
     */
    monitorMemoryUsage(contextId, sessionId, memoryUsageMb) {
    ...
    triggerAlert(alertData) {
        ...
        const existingAlert = Array.from(this.activeAlerts.values()).find(existing => existing.type === alert.type &&
    ...
    checkPerformanceThresholds(operation, executionTimeMs, contextId, sessionId) {
        let threshold;
    ...
    updatePerformanceBaseline(operation, executionTimeMs) {
...
exports.ContextMonitorService = ContextMonitorService;
