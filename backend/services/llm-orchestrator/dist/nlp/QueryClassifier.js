...
class QueryClassifier {
    ...
    calculateIntentScores(normalizedQuery) {
        ...
        scores.component_identification += componentMatches * 0.3;
        ...
        if (sortedScores[0][1] > sortedScores[1][1] + 0.3) {
            scores[sortedScores[0][0]] = Math.min(scores[sortedScores[0][0]] + 0.2, 1.0);
        }
        return scores;
    }
    /**
