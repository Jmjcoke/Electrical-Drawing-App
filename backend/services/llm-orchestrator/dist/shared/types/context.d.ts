...
export type ContextMetricType = 'retrieval_time_ms' | 'follow_up_detection_time_ms' | 'context_enhancement_time_ms' | 'storage_size_bytes' | 'turn_count' | 'relevance_score' | 'compression_ratio' | 'cache_hit_rate' | 'accuracy_score';
...
export type ContextAlertType = 'performance_degradation' | 'storage_limit_exceeded' | 'accuracy_drop' | 'memory_leak' | 'error_rate_spike' | 'cache_miss_rate_high';
export interface ContextWebSocketEvents {
    'context-enhance-query': {
        queryText: string;
        sessionId: string;
    };
    'context-reset': {
